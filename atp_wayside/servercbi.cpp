...
quint8 ServerCBI::getByteStatus_M() const
{
    return byteStatus_M;
}

quint8 ServerCBI::getByteStatus_B() const
{
    return byteStatus_B;
}
...
void ServerCBI::timeoutCheck()
{
    ...
    //Timeout check
    if(cTicks_M >= 10) {cTicks_M=10; rxData_M.clear();status_M = "Timeout.";byteStatus_M=0;}
    if(cTicks_B >= 10) {cTicks_B=10; rxData_B.clear();status_B = "Timeout.";byteStatus_B=0;}
